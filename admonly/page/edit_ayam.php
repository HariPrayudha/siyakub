...
if (isset($_POST['edit_ayam'])) {
    ...
    if (!empty($_FILES["gambar"]["name"])) {
        ...
        $stmt = $koneksi->prepare("UPDATE ayam SET gambar=:gambar, nama=:nama, harga=:harga, deskripsi=:deskripsi WHERE id=:id");
        $stmt->bindParam(':gambar', $photo_file);
    } else {
        $stmt = $koneksi->prepare("UPDATE ayam SET nama=:nama, harga=:harga, deskripsi=:deskripsi WHERE id=:id");
    }
...
<div class="edit">
    <section class="panel">
        <a href="index.php?page=ayam">
            << Kembali Ke Manajemen Jenis Ayam </a>
                <form method="post" action="" enctype="multipart/form-data">
                    <fieldset style="border: 1px solid orange;">
                        ...
                        <input type="text" name="harga" placeholder="Harga Ayam" class="form-control" value="<?php echo htmlspecialchars($result['harga']); ?>"> <br>
